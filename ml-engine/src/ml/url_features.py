"""
Extraction de caractéristiques lexicales à partir d'une URL, utilisées
comme features pour la détection de phishing.
...
def extract_features(url):
    ...
    netloc = parsed.netloc.split(":")[0]  # on retire le port éventuel
    path = parsed.path or ""
    full = url.lower()
